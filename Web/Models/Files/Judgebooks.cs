...
{
   public JudgebookFilesAdminRequest(int typeId, string courtType, string year = "", string category = "", string num = "", int page = 1, int pageSize = 10)
   {
      Model = new JudgebookFile(typeId, courtType, year, category, num);
      Page = page < 1 ? 1 : page;
